...
Shader "StylizedWater/Particle/Mobile"
{
		...
		SubShader
	{
		...
		Tags{
		"RenderType" = "TransparentCutout"  "Queue" = "Transparent+1" "IgnoreProjector" = "True" "IsEmissive" = "true"
	}
		Pass
	{
...
#include "UnityCG.cginc"
	...
	{
		float clipMask = step((1.0 - i.color.a) , tex2D(_Disolve, i.uv1).r * tex2D(_MainTex, i.uv0).r);
		clip(clipMask - 0.5);
